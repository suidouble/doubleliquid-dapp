<template>
	...
	<div>
        ...
        <div class="row">
            <div class="col col-12 col-lg-5 col-md-6">
                <SimulationPriceChart :simulation1="simulation1" :epoch="selectedEpoch"  v-if="simulation1" />
            </div>
            <div class="col col-12 col-lg-2 gt-md">
                &nbsp;
            </div>
            <div class="col col-12 col-lg-5 col-md-6">
